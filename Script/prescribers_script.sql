...
-- Select prescriber.npi, Count(total_claim_count_ge65) AS count_of_claim,nppes_provider_last_org_name,nppes_provider_first_name
-- From prescriber
...
-- Select prescriber.npi, Count(total_claim_count_ge65) AS count_of_claim,nppes_provider_last_org_name,nppes_provider_first_name, specialty_description
-- From prescriber
-- Inner Join prescription
-- On prescriber.npi = prescription.npi
